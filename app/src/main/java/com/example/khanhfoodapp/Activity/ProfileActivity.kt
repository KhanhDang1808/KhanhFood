...
//                binding.imageUser.setImageBitmap(bitmap)
    ...
    private fun initListener() {
        ...
        binding.imageUser.setOnClickListener { setPicUser() }
        binding.textImageUser.setOnClickListener { setPicUser() }
        ...
        binding.layoutEmail.setOnClickListener {
                if (!checkEmail()) {
                    binding.textEmail.text = mCurrentUser.email
                }
...
//        }
    ...
    private fun uploadImageToFirebase(imageUri: Uri) {
        ...
        val imagesRef = storageRef.child("ImageUser/${UUID.randomUUID()}")
        ...
        uploadTask.addOnSuccessListener { taskSnapshot ->
            ...
            taskSnapshot.storage.downloadUrl.addOnSuccessListener { uri ->
                mUri = uri
                    ...
                    val my = database.getReference("Users")
                    my.child("${mAuth.currentUser?.uid}").updateChildren(map)
